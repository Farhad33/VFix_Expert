...
public struct ARSLineProgressConfiguration {
    ...
    public static var failCrossColor: CGColor = UIColor.ars_colorWithRGB(20.0, green: 157.0, blue: 234.0, alpha: 1.0).CGColor
    
    public static var failCircleAnimationDrawDuration: CFTimeInterval = 0.7
    public static var failCircleLineWidth: CGFloat = 2.0
    public static var failCircleColor: CGColor = UIColor.ars_colorWithRGB(20.0, green: 157.0, blue: 234.0, alpha: 1.0).CGColor
